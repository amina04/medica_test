...
const klabelTextStyle = TextStyle(
    fontSize: 16.4, color: Colors.black54, fontWeight: FontWeight.w400);
const klabelresultatStyle =
    TextStyle(fontSize: 15.2, color: Colors.black, fontWeight: FontWeight.w500);
const kappBarTextStyle = TextStyle(fontSize: 21, color: Colors.white);
...
Color colorOne = Colors.tealAccent[400];
Color colorTwo = Colors.tealAccent;
Color colorThree = Colors.tealAccent[100];
